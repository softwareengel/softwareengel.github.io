...
class MTTFCalculator:
    ...
    def calculate_mttf(self):
        # TODO Berechne den Mittelwert der in "failures" gespeicherten Werte 
        # und gebe das Ergebnis zurueck. 
        # Tipp: Hierzu benoetigst du die "return"-Anweisung. 
        # Das pass kannst du loeschen, sobald du deinen Code schreibst.
        anzahlElem = len(self.failures)
        sumeElem = sum(self.failures)
        if anzahlElem == 0 :
            return 0
        mttf = sumeElem / anzahlElem
        return mttf
