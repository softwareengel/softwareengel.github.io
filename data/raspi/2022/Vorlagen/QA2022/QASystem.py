...
class QASystem:
    ...
    def __init__(self):
        ...
        # TODO Rufe den Konstruktor von MTTFCalculator (s. Datei MTTF) auf und speichere das Objekt in der Instanzvariable "self.mttf_calculator". Tipp: Konstruktoren werden mit "Klassenname()" aufgerufen. Ein Beispiel ist die Definition von "self.rule_checker" weiter unten.
